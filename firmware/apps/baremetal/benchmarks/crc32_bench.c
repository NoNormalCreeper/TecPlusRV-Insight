...
#define BYTES 4096u
#define EXPECTED_CRC32 0xc0e65e2bu
...
int main(void)
{
    ...
    test_expect(bram_crc == EXPECTED_CRC32, 0xdead8201u);
    test_expect(bram_crc == sdram_crc, 0xdead8202u);
    test_expect(crc32_bench_sink != 0u, 0xdead8203u);
    test_pass();
    return 0;
}
