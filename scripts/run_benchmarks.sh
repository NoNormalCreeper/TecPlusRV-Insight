...
run_workload "memset_bench" "firmware/tests/memset_bench.c" "minisoc_sdram_pico" "minisoc_sdram_dark"
run_workload "stride_bench" "firmware/tests/stride_bench.c" "minisoc_sdram_pico" "minisoc_sdram_dark"
run_workload "crc32_bench" "firmware/tests/crc32_bench.c" "minisoc_sdram_pico" "minisoc_sdram_dark"
