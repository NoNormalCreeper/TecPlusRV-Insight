...
case "$SIM_KIND" in
    ...
    dot4_bench_dark)
        ...
        FIRMWARE_ACCEL=dot4 \
            compile_minisoc_tb "$BUILD_DIR/tb_dot4_bench_dark.out" 1 \
                tb_minisoc "$REPO_ROOT/sim/tb_minisoc.v"
        run_and_check "$BUILD_DIR/tb_dot4_bench_dark.log" \
            vvp "$BUILD_DIR/tb_dot4_bench_dark.out"
        ;;
    machine_timer)
